...
def data_dumping():
    leisure = [
        {"latitude": "59.90266", "longitude": "30.47485", "address": "ул. Дыбенко, 23к3", "name": "Спортплощадка",
         "type": "Спорт", "description": "", "language": "", "rating": 4},
        {"latitude": "45.84887", "longitude": "40.12593", "address": "ул. Подвойского, 17", "name": "Спортплощадка",
         "type": "Спорт", "description": "", "language": "", "rating": 2.2},
        {"latitude": "55.46934", "longitude": "38.33663", "address": "Центральная ул., 54к1", "name": "Летний каток",
         "type": "Спорт/отдых", "description": "Каток от 300руб/час", "language": "Русский", "rating": 3.4},
        {"latitude": "59.89706", "longitude": "30.49369", "address": "пр. Большевиков, 38к1", "name": "Футбольное поле",
    ...
    religion = [
        {"latitude": "60.01775", "longitude": "30.28112", "address": "Репищева ул., 1, Санкт-Петербург",
         "name": "Квартальная мечеть им. Джафара Насибулловича", "type": "Мечеть",
        ...
        {"latitude": "59.95523", "longitude": "30.3239", "address": "Кронверкский просп., 7, Санкт-Петербург",
         "name": "Соборная мечеть", "type": "Мечеть",
        ...
        {"latitude": "59.92412", "longitude": "30.31809",
         "address": "Московский просп., 10-12Г, Санкт-Петербург", "name": "Соборная мечеть, молельная комната",
        ...
        {"latitude": "59.92263", "longitude": "30.46424", "address": "парк Оккервиль",
         "name": "Изучение Карана в парке", "type": "Встреча", "description": "Общаемся и познаём Аллаха",
         "language": "русский, узбекский", "rating": 4.9}]
    life = [
        {"latitude": "59.90339", "longitude": "30.47485", "address": "пр. Большевиков, 25", "name": "Только ты",
         "type": "Парикмахерская", "description": "Профессиональные стилисты и визажисты со всей страны!",
         "language": "Русский", "rating": 3.4},
        {"latitude": "59.901", "longitude": "30.48305", "address": "ул. Шотмана, 7к1", "name": "Парикмахерская",
        ...
        {"latitude": "59.89681", "longitude": "30.51033", "address": "Центральная ул., д.54 к.2, Кудрово",
         "name": "РЕСО-мед", "type": "Медицина", "description": "Здесь можно купить все лекарства",
         "language": "Русский", "rating": 2.9},
        {"latitude": "59.9001", "longitude": "30.52047", "address": "просп. Строителей, 33, Кудрово",
         "name": "МФЦ ГБУ ЛО", "type": "МФЦ", "description": "Многофункциональный центр",
    ...
    food = [
        {"latitude": "59.91416", "longitude": "30.47454", "address": "просп. Большевиков, 9, корп. 1, Санкт-Петербург",
         "name": "Чайхана Чабрец", "type": "Кафе", "description": "Вкусно и недорого!",
        ...
        {"latitude": "59.90773", "longitude": "30.48502", "address": "просп. Большевиков, 18, Санкт-Петербург",
         "name": "Макдоналдс", "type": "Кафе", "description": "Известные бургеры и кола", "language": "", "rating": 4.3,
        ...
        {"latitude": "59.90442", "longitude": "30.50956", "address": "Европейский просп., 13, корп. 1, Кудрово",
         "name": "Шаверма Евро Кебаб", "type": "Кафе", "description": "Шаверма", "language": "русский, киргизский",
         "rating": 4,
        ...
        {"latitude": "59.9031371", "longitude": "30.5123403", "address": "Европейский просп., 13, корп. 6, Кудрово",
         "name": "Мясной № 1", "type": "Продуктовый", "description": "", "language": "русский, узбекский",
         "rating": 4.6, "reviews": ""},
        {"latitude": "59.90401", "longitude": "30.51957", "address": "Английская ул., 2, Кудрово", "name": "Дикси",
        ...
        {"latitude": "59.9036", "longitude": "30.50919", "address": "Австрийская ул., 4, корп. 1, Кудрово",
         "name": "Семишагофф", "type": "Продуктовый", "description": "", "language": "русский, узбекский, киргизский",
         "rating": 3.5,
    ...
    culture = [
        {"latitude": "59.90061", "longitude": "30.50858", "address": "Венская ул., 4, корп. 1, Кудрово",
         "name": "EXPODOM", "type": "Выставка", "description": "Постоянная выставка загородного строительства",
         "language": "Русский, Английский", "rating": 3},
        {"latitude": "59.901", "longitude": "30.48305", "address": "ул. Шотмана, 7/1",
         "name": "Невская ЦБС. Библиотека № 5 им. Н. Рубцова", "type": "Библиотека",
        ...
        {"latitude": "59.90773", "longitude": "30.48502", "address": "ТРК Невский, пр. Большевиков, 18",
         "name": "Картины в дом", "type": "Картинная галерея", "description": "", "language": "", "rating": 2.3},
        {"latitude": "59.9006", "longitude": "30.5087", "address": "Венская ул., 3", "name": "Шить - Легко!",
    ...
    development = [
        {"latitude": "59.9027904", "longitude": "30.5170321", "address": "Английская улица, 3",
         "name": "Курсы русского языка", "type": "Курсы",
        ...
        {"latitude": "59.9030465", "longitude": "30.5127805", "address": "Европейский просп., 14, Кудрово",
         "name": "Академия цифровых технологий", "type": "Курсы",
        ...
        {"latitude": "59.9053", "longitude": "30.52055", "address": "Пражская ул., 15, Кудрово",
         "name": "ЦОПП «Профстандарт»", "type": "Курсы",
        ...
        {"latitude": "59.89681", "longitude": "30.51033", "address": "Центральная ул., 54, корп. 2, Кудрово",
         "name": "Готовим плов", "type": "Мастер-класс", "description": "Научим готовить очень вкусный плов",
